...
CREATE TABLE `class_subjects` (
  ...
  KEY `FKlmkc1jg81w5pab7ltlm0noptk` (`class_id`),
  CONSTRAINT `FKck6avvuoer3mgm2mbjgs0gw6m` FOREIGN KEY (`subject_id`) REFERENCES `subjects` (`id`),
  CONSTRAINT `FKlmkc1jg81w5pab7ltlm0noptk` FOREIGN KEY (`class_id`) REFERENCES `class` (`id`)
...
-- Dump completed on 2023-03-14 14:41:28
