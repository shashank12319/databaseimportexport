...
CREATE TABLE `teacher_students` (
  ...
  UNIQUE KEY `UK_etid2v4wmwue8bi694h72adop` (`students_id`),
  KEY `FKbopxax3tivjp8cdjbt0vvm1w3` (`teacher_teacher_id`),
  CONSTRAINT `FKbopxax3tivjp8cdjbt0vvm1w3` FOREIGN KEY (`teacher_teacher_id`) REFERENCES `teacher` (`teacher_id`),
  CONSTRAINT `FKhstoj4yep9m2vr6wh8cvq1upf` FOREIGN KEY (`students_id`) REFERENCES `student` (`id`)
